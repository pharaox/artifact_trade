...
The current version is compatible with CK3 1.15. If you are still on CK3 1.14.x, use [version 0.12.2](https://github.com/pharaox/artifact_trade/releases/download/0.12.2/search_and_trade_artifacts-0.12.2.zip) instead.
